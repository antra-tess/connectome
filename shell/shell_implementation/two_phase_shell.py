...
class TwoPhaseShell(BaseShell):
    ...
    def __init__(self,
        ...
        if not self.inner_space:
            self.logger.error("InnerSpace not initialized in TwoPhaseShell")
            raise RuntimeError("InnerSpace not initialized in TwoPhaseShell")
        ...
        self.logger.info("Two-Phase Shell initialized with verified InnerSpace")
