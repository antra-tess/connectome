...
class EnvironmentManager:
    ...
    def register_environment(self, environment: Environment) -> bool:
        ...
        logger.info(f"Registered environment: {environment.name} ({environment.id})")
        return True
    ...
    def register_message_observer(self, observer: Callable) -> None:
        ...
        Args:
            observer: Callable to be notified of new messages
        """
        self.message_service.register_message_observer(observer)
